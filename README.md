...
1. Предположительно, асимптотический предел ошибки в данной примере определяется среднеквадратическим отклонением шумов, наложенных при генерации синтетических данных. Например, установленному значению ${\sigma = 0.2}$ соответствует сумма квадратом отклонений ${0.2^2\cdot2000=80}$ (достигнуто 83.0865). Дополнительный эксперимент при ${\sigma = 0.1}$ подтверждает эту гипотезу.